...
{
    /// <summary>
    /// Extensions that make the CVWTerrain library work elegantly. Mainly functions to convert cleanly from Vector3 to Vector64 and vice versa, along with switching the handedness of the coordinate spaces a Vector64 is placed within.
    /// </summary>
